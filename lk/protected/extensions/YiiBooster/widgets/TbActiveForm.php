...
class TbActiveForm extends CActiveForm {
	...
	/**
	 * Generates a hidden field group for a model attribute.
	 *
	 * This method is a wrapper for {@link CActiveForm::hiddenField} and {@link customFieldGroup}.
	 * Please check {@link CActiveForm::hidenField} for detailed information about $htmlOptions argument.
	 * About $options argument parameters see {@link TbActiveForm} documentation.
	 *
	 * @param CModel $model The data model.
	 * @param string $attribute The attribute.
