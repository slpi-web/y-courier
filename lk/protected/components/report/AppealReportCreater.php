...
class AppealReportCreater extends ReportCreater
{
    ...
    protected function init()
    {
        ...
        $this->config = array(
            'organization' => Yii::t('appeal_report_creater', 'organization'),
            'businessCenter' => Yii::t('appeal_report_creater', 'business center'),
        );
