...
$this->pageTitle = Yii::t('client_pagetitle', 'Cse Delivery Calc Result');

$this->breadcrumbs=array(
    Yii::t('client_pagetitle', 'Cse Delivery') => array('list'),
    Yii::t('client_pagetitle', 'Cse Delivery Calc') => array('calc'),
    Yii::t('client_pagetitle', 'Cse Delivery Calc Result'),
);
?>
