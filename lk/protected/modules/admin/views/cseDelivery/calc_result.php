...
$this->pageTitle = Yii::t('admin_pagetitle', 'Cse Delivery Calc Result');

$this->breadcrumbs=array(
    Yii::t('admin_pagetitle', 'Cse Delivery') => array('list'),
    Yii::t('admin_pagetitle', 'Cse Delivery Calc') => array('calc'),
    Yii::t('admin_pagetitle', 'Cse Delivery Calc Result'),
);
?>
