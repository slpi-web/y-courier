...
$this->pageTitle = Yii::t('admin_pagetitle', 'Cse AddressBook Add');
...
<div class="modal-footer">
    <?php $this->widget(
        ...
        array('buttonType' => 'submit', 'label' => Yii::t('view_admin', 'Save'), 'htmlOptions' => array('id' => 'popup-submit', 'class' => 'btn-primary', 'name' => 'save'))
    ); ?>
    <?php $this->widget(
        'booster.widgets.TbButton',
        array(
            'label' => Yii::t('view_admin', 'Close'),
            'url' => '#',
            'htmlOptions' => array(
                'id' => 'popup-close',
                'data-dismiss' => 'modal'
