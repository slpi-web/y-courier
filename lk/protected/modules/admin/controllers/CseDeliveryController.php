...
class CseDeliveryController extends BaseAdminController
{
    ...
    {
        $model = new CseDeliveryAdmin('search');
    ...
    public function actionDelete($id)
    {
        ...
        if ($model->status == CseDelivery::STATUS_SYNC) {
            Yii::app()->user->setFlash('error', Yii::t('view_cse_form', 'Cant delete. Please wait for the synchronization.'));
        } else {
            $model->delete();
        }
    ...
    {
        $model = CseDeliveryAdmin::model()->findByPk($id);
