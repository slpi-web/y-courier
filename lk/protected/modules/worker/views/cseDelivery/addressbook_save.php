...
$this->pageTitle = Yii::t('worker_pagetitle', 'Cse AddressBook Add');
...
<div class="modal-footer">
    <?php $this->widget(
        ...
        array('buttonType' => 'submit', 'label' => Yii::t('view_worker', 'Save'), 'htmlOptions' => array('id' => 'popup-submit', 'class' => 'btn-primary', 'name' => 'save'))
    ); ?>
    <?php $this->widget(
