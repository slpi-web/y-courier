    ...
    array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'viewButtonUrl' => 'Yii::app()->createUrl("/worker/cseDelivery/getWaybill", array("id" => $data->id))',
                'updateButtonUrl' => 'Yii::app()->createUrl("/worker/cseDelivery/edit", array("id" => $data->id))',
                'buttons' => array(
                    'view' => array(
                    ...
                    'update' => array(
                        'visible' => 'in_array($data->status, array(CseDelivery::STATUS_NOT_VERIFIED, CseDelivery::STATUS_NOT_SYNCED))',
                    )
                )
            ),
        ),
